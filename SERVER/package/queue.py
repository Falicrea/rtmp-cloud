...
from .utils import hls_directory
from ..main import logger


def remove_old_stream():
    folders = [f for f in os.listdir(hls_directory) if os.path.isdir(os.path.join(hls_directory, f))]
    while True:
        ...
        for folder in folders:
            folder_path = os.path.join(hls_directory, folder)
            ...
            if age_hours > 72:
                ...
                logger.info(f"Remove stream name: {folder}")
